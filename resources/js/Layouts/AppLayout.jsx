...
import {
    ...
    ChevronRightIcon, BellIcon, SunIcon, MoonIcon
...
export default function AppLayout({ children, header }) {
    ...
    const navItems = [
        ...
        { href: '/team', icon: UsersIcon, label: 'Équipe' },
        { href: '/calendar', icon: CalendarIcon, label: 'Calendrier' },
        { href: '/budget', icon: CurrencyEuroIcon, label: 'Budget' },
    ];
        ...
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                <header className="flex items-center justify-between px-6 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <h1 className="text-lg font-semibold text-gray-800 dark:text-white">{header}</h1>
                </header>
